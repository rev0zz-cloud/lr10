...
*Сначала мы создаем экземпляр DocumentBuilderFactory и DocumentBuilder,
* чтобы получить объект Document, который является корневым элементом нашего XML-документа.
* Затем мы создаем элементы и добавляем их в документ,
* вызывая методы createElement и appendChild на соответствующих элементах.
* После того, как мы создали и заполнили XML-документ, мы используем Transformer для записи DOM-структуры в файл.
...
public class CreateXMLFile {
    public static void main(String[] args) {
        try {
            ...
            year2.appendChild(doc.createTextNode("1969"));
            ...
            javax.xml.transform.stream.StreamResult result =
                    new javax.xml.transform.stream.StreamResult(new File("src/lr10/example1/example1.xml"));
